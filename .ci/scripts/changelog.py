...
repo = Repo(os.getcwd())
heads = repo.git.ls_remote("--heads", "https://github.com/pulp/pulp_installer.git").split("\n")
...
def get_changelog(branch):
    ...
    """
    return requests.get(
        f"https://raw.githubusercontent.com/pulp/pulp_installer/{branch}/docs/CHANGES.md"
    ).text
