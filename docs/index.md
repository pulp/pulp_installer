...
This version of the installer, 3.6.5, installs Pulp 3.6.5.post2 specifically.

If run against an older version of Pulp 3, it will upgrade it to 3.6.5.post2.
...
1. Make sure you are running the latest version of the installer, which installs the latest version
   of pulpcore (3.6.5.post2).
1. Confirm that all the latest stable releases of your desired plugins are compatible with pulpcore
   3.6.5.post2, such as by reading the release announcement email thread for pulpcore 3.6.5.post2, reading the
...
1. Confirm that all the latest stable releases of **currently installed** plugins are compatible
   with pulpcore 3.6.5.post2, such as by reading the release announcement email thread for pulpcore 3.6.5.post2,
...
1. Observe the latest branch of `pulp_installer`, and what version of pulpcore it installs (3.6.5.post2).
1. Confirm that all the latest stable releases of your desired plugins are compatible with pulpcore
   3.6.5.post2, such as by reading the release announcement email thread for pulpcore 3.6.5.post2, reading the
plugins README, or as a last resort, reading their setup.py.
1. If they are not all compatible yet, try the last version of the installer that installs pulpcore
   3.5.z . Then confirm that there exist stable releases of your desired plugins that are compatible
with pulpcore 3.5.z. If there are none, try pulpcore 3.4.z, and repeat.
...
1. Observe what the latest version of `pulp_installer` is, and what version of pulpcore it installed
   (3.6.5.post2). (Even if there is no update, you can still upgrade your plugins.)
1. Confirm that all the latest stable releases of **currently installed** plugins are compatible
   with pulpcore 3.6.5.post2, such as by reading the release announcement email thread for pulpcore 3.6.5.post2,
reading the plugins README, or as a last resort, reading their setup.py.
1. If they are not all compatible yet, try the last version of the installer that installs pulpcore
